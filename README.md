<html>
  ...
  <head>
    ...
    <h1 style="color:#00ff00">For Software Engineers</h1>
  </head>
  <center>  
<body style="background-color:black;">
  <link rel="stylesheet" type="text/css" href="main.css" />
  <h1 style="color:#00ff00">GOTPHP.COM</h1>
  <button style="background:red;color:#00ff00;" onclick="location.href='mailto:ghostshell201@gmail.com'">Contact Me</button>
<button style="background:red;color:#00ff00;" onclick="location.href='https://paypal.me/khaledalkhawaga?country.x=EG&locale.x=en_US'">BUY IT For 3000$</button>
